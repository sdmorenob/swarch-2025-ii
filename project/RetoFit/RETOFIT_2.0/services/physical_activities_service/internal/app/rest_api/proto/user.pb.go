...
const file_proto_user_proto_rawDesc = "" +
	...
	"\vUserService\x120\n" +
	"\aGetUser\x12\x11.user.UserRequest\x1a\x12.user.UserResponseBSZQRetoFit-App/services/physical_activities_service/internal/app/rest_api/grpc/protob\x06proto3"
